"""HelloWorldNew Feed Integration for Cortex XSOAR (aka Demisto)
...
class Client(BaseClient):
    ...
    For this HelloWorldNew Feed implementation, no special attributes defined
    """
...
def get_indicators_command(client: Client,
    ...
    human_readable = tableToMarkdown('Indicators from HelloWorldNew Feed:', indicators,
...
def main():
    ...
    try:
        ...
        elif command == 'helloworldNew-get-indicators':
